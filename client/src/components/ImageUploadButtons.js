...
const ImageUploadButtons = ({ target, clearImage, resetOptions, enableCanvas, advanced }) => {
    ...
    return (
        <Stack direction='column' spacing={1}>
            ...
            {advanced && <Button variant='contained' size='small' onClick={resetOptions} startIcon={<RestartAltIcon />} disabled={disabled}>Reset</Button>}
            {!disabled && <>
            ...
            {advanced && <Button variant='contained' size='small' onClick={enableCanvas} disabled={disabled}>Configure</Button>}
